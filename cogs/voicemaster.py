...
from cogs.helpers import commandhelp, noperms
...
class vmbuttons(discord.ui.View):
    ...
    @discord.ui.button(label="", emoji="<:emoji_4:1230495578807472138>", style=discord.ButtonStyle.gray, custom_id="persistent_view:unlock")
    ...
    @discord.ui.button(label="", emoji="<:emoji_6:1230495631383199865>", style=discord.ButtonStyle.gray, custom_id="persistent_view:reveal")
    ...
    @discord.ui.button(label="", emoji="<:emoji_6:1230495604829061202>", style=discord.ButtonStyle.gray, custom_id="persistent_view:hide")
    ...
    @discord.ui.button(label="", emoji="<:emoji_10:1230495762601742437>", style=discord.ButtonStyle.gray, custom_id="persistent_view:rename")
    ...
    @discord.ui.button(label="", emoji="<:emoji_8:1230495665503731712>", style=discord.ButtonStyle.gray, custom_id="persistent_view:increase")
    ...
    @discord.ui.button(label="", emoji="<:emoji_9:1230495690912829550>", style=discord.ButtonStyle.gray, custom_id="persistent_view:decrease")
    ...
    @discord.ui.button(label="", emoji="<:emoji_11:1230495801143332976>", style=discord.ButtonStyle.gray, custom_id="persistent_view:claim")
    ...
    @discord.ui.button(label="", emoji="<:emoji_12:1230495831216619612>", style=discord.ButtonStyle.gray, custom_id="persistent_view:info")
    ...
    @discord.ui.button(label="", emoji="<:emoji_13:1230495859305873528>", style=discord.ButtonStyle.gray, custom_id="persistent_view:delete")
    ...
    if option == None:
     ...
     async with self.bot.db.cursor() as cursor: 
      ...
      if check is not None:
        ...
        em.add_field(name="Button Usage", value="<:emoji_4:1230495550005186580> - [`lock`](https://discord.gg/aware) the voice channel\n<:emoji_4:1230495578807472138> - [`unlock`](https://discord.gg/aware) the voice channel\n<:emoji_6:1230495631383199865> - [`reveal`](https://discord.gg/aware) the voice channel\n<:emoji_6:1230495604829061202> - [`hide`](https://discord.gg/aware) the voice channel\n<:emoji_10:1230495762601742437> - [`rename`](https://discord.gg/aware) the voice channel\n<:emoji_8:1230495665503731712> - [`increase`](https://discord.gg/aware) the user limit\n<:emoji_9:1230495690912829550> - [`decrease`](https://discord.gg/aware) the user limit\n<:emoji_11:1230495801143332976> - [`claim`](https://discord.gg/aware) the voice channel\n<:emoji_12:1230495831216619612> - [`info`](https://discord.gg/aware) of the voice channel\n<:emoji_13:1230495859305873528> - [`delete`](https://discord.gg/aware) a voice channel")    
